...
export const FORM_SCHEMAS = {
  "People": {
    ...
    headers: [
      "Record ID",
      "Full name", "Date of birth", "Adult or Youth",
      "Email", "Phone (home)", "Phone (cell)",
      "Address", "City", "Province", "Postal code",
      "Attending since", "Attends 2+ services/month", "Church member", "Baptized", "Open to baptism",
      "Spiritual journey",
      "Prior church 1 name", "Prior church 1 phone", "Prior church 1 dates", "Prior church 1 status", "Prior church 1 roles",
      "Prior church 2 name", "Prior church 2 phone", "Prior church 2 dates", "Prior church 2 status", "Prior church 2 roles",
      "Age groups interested", "Service times available", "Skills / experience",
      "Criminal offense", "Child welfare investigation", "Misconduct termination", "Personal circumstances", "Health concerns",
      "Screening explanation",
      "Reference 1 name", "Reference 1 phone", "Reference 1 email", "Reference 1 relationship", "Reference 1 years known",
      "Reference 2 name", "Reference 2 phone", "Reference 2 email", "Reference 2 relationship", "Reference 2 years known",
      "Applicant signature", "Applicant signed date",
      "Witness signature", "Witness signed date",
      "Youth: grade", "Youth: parent/guardian name", "Youth: parent/guardian phone",
      "Youth: parents supportive",
      "Youth: faith", "Youth: why serve", "Youth: gifts", "Youth: concerns about working with children",
      "Youth: volunteer experience",
      "Youth ref 1 name", "Youth ref 1 phone/email", "Youth ref 1 relationship",
      "Youth ref 2 name", "Youth ref 2 phone/email", "Youth ref 2 relationship",
      "Youth signature", "Youth signed date",
      "Parent/Guardian signature", "Parent/Guardian signed date",
      "Parent consent witness signature", "Parent consent witness signed date",
      "Submitted at",
    ],
  },
  "Incidents": {
